...
// };
  ...
  //this.model.save({name: "hola", desc:"jajaja"});
  //console.log(Note);
  // Note Collection
  // ---------------
  ...
  // list view: aca se listan las notas
  ...
  var NoteView = Backbone.View.extend({
    ...
    updateOnKeyup: function(e){
      ...
      this.model.save({name: name, desc: desc, date :  Date.now()},
      {
      ...
      //console.log(this.model.save({name: name, desc: desc}));
    },
